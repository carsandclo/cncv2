...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: DZgqSGOmUHCw/css
      ...
      triggerSlot={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__d6Bpx)}
                >
                  {"Show dialog"}
                </Button>
              ),
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__iCjsc)}
              >
                <div
                  className={classNames(
                    projectcss.all,
